...
```
```{r, include = FALSE}
kable(head(mbb_raw_printing,5), caption = "Table 1. Example of raw men's model data")
```
```{r, include=FALSE}
...
```
```{r, include=FALSE}
kable(head(model_data_printing,5), caption = "Table 2. Example of cleaned men's model data")
```
...
```
```{r, include = FALSE}
kable(head(wbb_raw_printing,5), caption = "Table 3. Example of raw women's model data")
```
...
```{r, include = FALSE}
kable(head(men_4099,5), caption = "Table 4. Men's HDI data")
```
...
```{r, include = FALSE}
kable(head(women_4099,5), caption = "Table 5. Women's HDI data")
```
