...
```
```{r conf_scatter, fig.width=4, fig.height=3, fig.align='center', echo=FALSE, fig.cap = "Conference strength across men's and women's conferences"}
conf_scatterplot
```
```{r conf_hist, echo = FALSE, fig.width=4, fig.height=3, fig.align='center', fig.cap="Conference strength vs. strength of schedule for men's and women's conferences."}
conf_hist
```
