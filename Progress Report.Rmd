...
wbb_final_ratings = read.csv("Data/wcbb_final_ratings.csv")
...
conf_scatterplot = ggplot(conf_both, aes(x = conf_strength_z, 
  ...
  labs(
    title = "Conference Strength vs. Strength of Schedule",
...
conf_hist = ggplot(conf_both, aes(x = conf_strength_z)) +
  ...
  labs(
    title = "Distribution of Conference Strength (z-scores) by Gender",
    x = "Conference strength (z-score)",
    y = "Count"
    ) + theme_minimal(base_size = 11)
```
